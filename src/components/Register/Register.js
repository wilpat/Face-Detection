        ...
        <div className="measure">
          <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
            ...
            <div className="mt3">
              ...
              <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="text" name="" />
            </div>
          ...
          <div className="">
            ...
            type="submit" 
            value="Register" 
            onClick = { () => routeChange('home') } /*This is how you do onClick fxns that have parameters in react, else the fxn inside would run 
